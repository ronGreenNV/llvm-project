...
private:
  ...
  void handleExplicitDummy(
    ...
    // -Mnocfi (LoweringOptions::NoCFIDescriptor): for BIND(C) dummies whose
    ...
    const bool useLegacyBindCArrayPassing = isBindC &&
        getConverter().getLoweringOptions().getNoCFIDescriptor() &&
    ...
    if (obj.attrs.test(Attrs::Allocatable) || obj.attrs.test(Attrs::Pointer)) {
      ...
      mlir::emitWarning(loc,
          ...
          "because CFI descriptor support is disabled for this compilation");
